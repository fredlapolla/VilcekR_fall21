...
```{r}
 crusio1$attack_combine<- factor(crusio1$attack_combine, levels = 0:1, labels = c("No", "Yes"))
summary(crusio1$attack_combine)
```
...
Make a factor variable out of the attack day 1 variable. 
...
```{r}
WannaMatrix <- as.matrix(WannaMatrix, ncol = 4) 
class(WannaMatrix)
